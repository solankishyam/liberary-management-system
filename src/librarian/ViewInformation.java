...
public class ViewInformation {
    public static void viewInfo(int UserID) {
        try {
            ...
            PreparedStatement ps = c.prepareStatement("select FirstName as 'First Name', LastName as 'Last Name', PhoneNumber as 'Phone Number', Gender, Email from librarian where UserID = ?");
            ps.setInt(1, UserID);
